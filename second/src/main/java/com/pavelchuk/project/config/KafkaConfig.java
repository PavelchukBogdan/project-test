...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, UserMessageDto> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigs(), new StringDeserializer(),
                new JsonDeserializer<>(UserMessageDto.class, false));
    }

    @Bean(name = "userMessageKafkaListenerContainerFactory")
    public ConcurrentKafkaListenerContainerFactory<String, UserMessageDto> userMessageKafkaListenerContainerFactory() {
